...
<c:set var="title" value="Books by ${author.name}" />
...
<div class="row mb-3">
    ...
    <div class="col-md-4 text-end">
        <a href="<c:url value='/authors/${author.id}' />" class="btn btn-secondary">
        ...
        <c:otherwise>
            <div class="col-md-12">
                <div class="alert alert-info">
                    No books found for this author. <a href="<c:url value='/books/new' />">Add a new book</a>.
                </div>
            </div>
        </c:otherwise>
    </c:choose>
